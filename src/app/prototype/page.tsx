    ...
    <SmoothProvider>
      ...
      <div style={{ background:BG, color:CREAM }}>
        ...
        <section ref={officeRef} id="private-office"
          ...
          {/* Malibu ocean sunset background */}
          <div className="absolute inset-0">
            <Image
              src="/images/malibu-mountains-ocean-sunset.jpg"
              alt="Malibu coastline at sunset"
              fill
              className="object-cover object-center slow-drift saturate-[0.55] contrast-[0.88] brightness-[0.65]"
              sizes="100vw"
            />
